...
namespace NewsPaper.Controllers
{
    public class WebAuthController : Controller
    {
        ...
        public WebAuthController(WebAuthService authService, TokenProvider tokenProvider)
        {
        ...
        {
            ResponseDto responseDto = await _webAuthService.LoginAsync(obj);
        ...
        public IActionResult Register()
        {
            ...
            {
                new SelectListItem{Text=StaticDetails.RoleModerator, Value=StaticDetails.RoleModerator},
        ...
        {
            ResponseDto result = await _webAuthService.RegisterAsync(obj);
            ...
            if (result != null && result.IsSuccess)
            {
                ...
                assignRole = await _webAuthService.AssignRoleAsync(obj);
